...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A1628] text-white max-w-[430px] mx-auto">
      {/* Header */}
      <header className="px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg">BasePulse AI</span>
        </div>
      ...
      <footer className="px-4 py-8 border-t border-blue-900/30">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 text-xs">
            © 2025 BasePulse AI. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
