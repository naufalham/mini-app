        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-[#0F1328] border-t border-blue-900/30 px-4 py-3">
            <div className="max-w-[430px] mx-auto flex items-center justify-around">
                <button
                    ...
                    className={`flex flex-col items-center gap-1 ${isActive('/dashboard') ? 'text-blue-500' : 'text-gray-400 hover:text-blue-400'} transition-colors`}
                >
                ...
                >
                    ...
                    <span className={`text-xs font-semibold ${isActive('/ai-content-studio') ? 'text-blue-400' : 'text-blue-400'}`}>AI Studio</span>
                </button>
                <button
                    onClick={() => navigate('/wallet')}
                    className={`flex flex-col items-center gap-1 ${isActive('/wallet') ? 'text-blue-500' : 'text-gray-400 hover:text-blue-400'} transition-colors`}
                >
